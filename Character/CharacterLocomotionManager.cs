...
namespace AP
{
    public class CharacterLocomotionManager : MonoBehaviour
    {
        ...
        [SerializeField] protected Vector3 yVelocity;  // THIS IS THE FORCE AT WHICH OUR CHARACTER WILL BE PULLED UP OR DOWN (Jumping or Falling)
        ...
        [SerializeField] protected float fallStartVelocity = -5;  // THE FORCE AT WHICH OUR CHARACTER BEGINS TO FALL WHEN THEY BECOME UNGROUNDED (RISES AS THEY FALL LONGER)
