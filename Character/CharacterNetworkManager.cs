...
namespace AP
{
    public class CharacterNetworkManager : NetworkBehaviour
    {
        ...
        {
            // WE MAKE SURE NOT TO RUN THE FUNCTION ON THE CHARACTER WHO SENT IT (SO WE DONT PLAY THE ANIMATION TWICE)
        ...
        public void NotifyTheServerOfCharacterDamageServerRpc(ulong damagedCharacterID,
        ...
        [ClientRpc]
        public void NotifyTheServerOfCharacterDamageClientRpc(ulong damagedCharacterID,
                                                              ulong characterCausingDamageID,
                                                              float physicalDamage, 
                                                              float magicDamage, 
                                                              float fireDamage, 
        ...
        public void ProcessCharacterDamageFromServer(ulong damagedCharacterID,
                                                     ulong characterCausingDamageID,
                                                     float physicalDamage, 
                                                     float magicDamage, 
                                                     float fireDamage, 
